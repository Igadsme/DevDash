...
import {
  ...
  GitCommit, Focus, BarChart2, Heart,
} from "lucide-react";
        ...
        <div className="flex-1 p-5 overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <div className="text-xs" style={{ color: "#6b6b80" }}>Here's what needs your attention.</div>
            </div>
    ...
    <div style={{ background: "#0a0a0c", minHeight: "100vh", color: "#f0f0f2" }}>
      ...
      <section className="px-6 md:px-12 lg:px-20 py-24 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            DevDash is built for developers, not managers. You control what's private, what's shareable, and what's never collected.
          </p>
