        ...
        <div className="relative mx-auto max-w-[1240px] px-5 pb-24 pt-5 md:px-8 md:pb-32">
          <header className="flex items-center justify-between">
            ...
            <nav className="hidden items-center gap-7 md:flex">
              ...
              <Link href="/signin" className="text-[11px] font-semibold text-[hsl(214_24%_92%/.62)] transition-colors hover:text-white">Sign in</Link>
              <Link href="/signup" className="flex items-center gap-2 rounded-md bg-[hsl(var(--accent))] px-3.5 py-2.5 text-[11px] font-bold text-[hsl(var(--accent-foreground))] transition-transform hover:-translate-y-0.5">Create account <ArrowRight size={13} /></Link>
            </nav>
