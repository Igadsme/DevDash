    ...
    <SiteShell user={user}>
      <Panel className="max-w-3xl">
        ...
        <div className="mt-8 border-t border-red-200 pt-6">
          <SectionHeader title="Delete account" description="Permanently remove your DevDash profile, synchronized activity, snapshots, and OAuth connection." />
          <form action={deleteAccount}>
            <Button type="submit" className="border border-red-300 bg-transparent text-red-700 hover:bg-red-50">
              Delete my account
            </Button>
          </form>
        </div>
